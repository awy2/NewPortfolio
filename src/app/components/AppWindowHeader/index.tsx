...
export default class AppWindowHeader extends React.Component<AppWindowHeaderProps> {
  ...
  render() {
    ...
    const AppHeader = styledComponents.div`
    ...
    const AppHeaderIcon = styledComponents.span`
    ...
    const AppHeaderCloseIcon = styledComponents.span`
      height: 100%;
      padding: 0 ${iconSpacing}rem;
      &:hover{
        height: ${headerHeight}rem;
    ...
    const AppHeaderIcons = styledComponents.span`
      height: 100%;
      float: right;
    ...
    return (
      <AppHeader>
        ...
        <AppHeaderIcons>
          <AppHeaderIcon>
            <Icon iconName="FontColorSwatch" className="ms-IconExample" />
          </AppHeaderIcon>
          <AppHeaderIcon>
            <Icon iconName="GridViewLarge" className="ms-IconExample" />
          </AppHeaderIcon>
